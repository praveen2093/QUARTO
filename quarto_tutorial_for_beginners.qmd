...
If you want to try a few simple R examples without installing R, open the dedicated R page with short notes and an in-browser WebR playground: [R — Getting Started](r.qmd).
